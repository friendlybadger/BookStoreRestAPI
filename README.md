...
- To Insert into the database change the address to  *** http://localhost:3001/Authors *** and Drop down menu to **POST** and click on Body tab and then click on raw buitton.
